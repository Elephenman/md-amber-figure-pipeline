...
ITEMS = [
    ...
    ("22","fig22_hbond_timeseries.png","机制","界面 H 键 2D 谱 (occupancy × 距离 × 角度)",
     "372 界面 H 键  ·  6 关键键高亮",
     "<em>fallback 版</em>（CHPC an3_hbdist 完整时序升级路径已就绪）。6 关键键：S167-G17 / N127-G17 / R207-T15 / R253-T24 / S251-T23 / R220-T22，全部高强度 (>65%)。"),
]
